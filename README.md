...
| 🔄 **Replace mode** (default ⌘D) | Bôi đen → bấm hotkey → text bị đè bằng bản dịch. Dùng khi compose tin nhắn. |
...
## Download (Tải về bản build sẵn)

Nếu bạn không muốn tự build code, có thể tải file `.dmg` cài đặt sẵn tại đây:

📥 **[Tải TranslateMate v1.0.0 (.dmg)](https://github.com/duongtuanvn/TranslateMate/releases/latest/download/TranslateMate-1.0.dmg)**

📖 **[Xem Hướng dẫn sử dụng chi tiết (User Guide)](USER_GUIDE.md)**

*(Đọc phần **Troubleshooting -> App is damaged** bên dưới để biết cách dùng lệnh `xattr -cr` mở app tải từ internet nhé).*
...
4. Test: mở Notes, gõ "Xin chào bạn", `Cmd+A` bôi đen, `⌘D` → text bị đè bằng "Hello, friend".
